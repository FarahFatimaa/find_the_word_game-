...
VEGETABLE_WORD = ['OTCRRA', 'OIRCCOBL', 'ROUFCWIALEL', 'RNOC', 'UCMUECRB', 'GGNALETP', 'EEGRN EREPPP', 'ECETTUL',
                  'OSMROSMUH', 'INNOO', 'OATPTO', 'UNPMIPK', 'RED EPEPPR', 'MOTTOA', 'ETEBTROO', 'EPAS', 'HIRSAD', 'BAGECBA',
                  'LILCHI','CLRGAI','TEWSE OTOAPT','ADIRNECOR',]
...
VEGETABLE_ANSWER = ['CARROT', 'BROCCOLI', 'CAULIFLOWER ', 'CORN ', 'CUCUMBER ', 'EGGPLANT', 'GREEN PEPPER ',
                    ...
                    'RADISH', 'CABBAGE', 'CHILLI', 'GARLIC', 'SWEET POTATO', 'CORIANDER', ]
...
def main():
    ...
    #this function change the word randomly.s
    def change():
        global ran_num
        ran_num = randrange(0, (len(VEGETABLE_WORD)))
