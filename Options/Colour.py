...
def main():
    ...
    def check():
        ...
        if user_word == COLOUR_ANSWER[ran_num]:
            ...
            get_input.delete(0, END)
    #this function give hint to user if score is equal to  or greater than 5.
    def show_answer():
        global points
        if points > 4:
            points -= 5
...
#create a Button widget.The text Change the word should appear on the face of the Button.s
    change = Button(
        text="Change Word",
        width=18,
        borderwidth=8,
